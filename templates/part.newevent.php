...
<?php print_unescaped($this->inc("part.eventform")); ?>
	...
	<div  class="button-group" style="float:right;">
		...
		<button  class="button" id="submitNewEvent" data-link="<?php print_unescaped(\OC::$server->getURLGenerator()->linkToRoute($_['appname'].'.event.newEvent')); ?>" style="min-width:60px;"><?php p($l->t('Save'));?></button>
	</div>
	</div>
