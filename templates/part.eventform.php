...
<table width="100%">
		<tr>
			<td>
				...
				<input type="text" style="width:100%;width:calc( 100% - 15px );font-size:16px; color:#555;padding:5px;"  placeholder="<?php p($l->t('Title'));?>" value="<?php p(isset($_['title']) ? $_['title'] : '') ?>" maxlength="100" name="title" id="event-title" autofocus="autofocus"/>

				<div id="sCalSelect" class="combobox">
					<div class="selector"><?php p($l->t('Choose calendar')); ?></div>
					<ul>
						<?php
		...
		<tr>
			<td>
			<input type="text" style="width:100%;width:calc( 100% - 15px );font-size:14px;font-family:Arial, fontello;float:left;"  placeholder="&#xe852; <?php p($l->t('Location'));?>" value="<?php p(isset($_['location']) ? $_['location'] : '') ?>" maxlength="100"  name="location" />
		...
		<tr>
			...
			<tr id="rEndRepeat">
				...
				<div>
					...
					<br />
					<textarea style="width:100%;height: 30px;font-family:Arial, fontello;font-size:14px;"  placeholder="&#xe845; <?php p($l->t('Description'));?>" name="description"><?php p(isset($_['description']) ? $_['description'] : '') ?></textarea>
					<br />
